...
const LEGACY_DENSITY: Record<string, DefaultFields> = {
  ...
  CellNoise2D: { Scale: 100.0, Seed: "A" },
  CellNoise3D: { Scale: 100.0, Seed: "A" },
  Sum: {},
  SumSelf: { Count: 2 },
  WeightedSum: {},
  Multiplier: {},
  ...
  AmplitudeConstant: { Scale: 1.0, Offset: 0.0 },
  Interpolate: {},
  XValue: {},
  YValue: {},
  ZValue: {},
  ...
  Cache: { Capacity: 3 },
  Wrap: {},
  Slider: { Translation: { x: 0, y: 0, z: 0 } },
  Scale: { Scale: { x: 1, y: 1, z: 1 } },
  Rotator: { AngleDegrees: 0 },
