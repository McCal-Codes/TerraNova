...
export const NODE_ID_PREFIX_RULES = {
  ...
  sadLayer: (type: string): string => `${type}.Layer`,
  sadCondition: (type: string): string => `${type}.Condition`,
  layer: (type: string): string => `${type}.Layer`,
  condition: (type: string): string => `${type}.Condition`,
  ...
  propdistribution: (type: string): string => `${type}.PropDistribution`,
  ...
  biome: (): string => "Biome",
  worldstructure: (type: string): string => `${type}.WorldStructure`,
  terrain: (): string => "Terrain",
  generator: (type: string): string => `${type}.Generator`,
  cavegenerator: (type: string): string => `${type}.CaveGenerator`,
