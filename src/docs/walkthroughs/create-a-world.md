...
> **Next:** Read the [Biome System guide](../guides/hytale-worldgen-v2-biome-system.md) to add multiple biomes with transitions, or the [Node Combinations guide](../guides/node-combinations.md) to learn common terrain patterns.
