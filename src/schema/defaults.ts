...
const LEGACY_DENSITY: Record<string, DefaultFields> = {
  ...
  SmoothFloor: { WallA: 0.0, WallB: 0.0 },
  SmoothMin: {},
  SmoothMax: {},
  AmplitudeConstant: {},
  Pow: { Exponent: 2.0 },
  ...
  SmoothCeiling: { WallA: 1.0, WallB: 0.0 },
  ...
  FastGradientWarp: { WarpFactor: 1.0, Seed: "A", WarpScale: 1.0, WarpOctaves: 3, WarpLacunarity: 2.0, WarpPersistence: 0.5, Is2D: false },
