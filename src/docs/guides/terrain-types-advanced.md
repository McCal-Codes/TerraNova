...
- Use `FastGradientWarp` over `GradientWarp` here — chained `GradientWarp` in 3D mode costs 6+6+1 = 13 noise evaluations per point; chained `FastGradientWarp` costs only 1+1+1 = 3
