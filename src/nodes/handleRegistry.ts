...
const HANDLE_OVERRIDES: Record<string, HandleDef[]> = {
  ...
  PositionsPinch: [densityInput("Input", "Input"), positionInput("Positions", "Positions"), curveInput("PinchCurve", "Pinch Curve"), densityOutput()],
  PositionsTwist: [densityInput("Input", "Input"), positionInput("Positions", "Positions"), curveInput("TwistCurve", "Twist Curve"), vectorInput("TwistAxis", "Twist Axis"), densityOutput()],
  ...
  "Material:SpaceAndDepth": [
    ...
    materialInput("Layers[0]", "Layer 0"),
    materialInput("Layers[1]", "Layer 1"),
    materialOutput(),
  ],
